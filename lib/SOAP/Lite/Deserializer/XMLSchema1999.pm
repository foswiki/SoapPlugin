...
sub as_string;
*as_string = \&SOAP::Lite::Deserializer::XMLSchemaSOAP1_1::as_string;
sub as_boolean;
*as_boolean = \&SOAP::Lite::Deserializer::XMLSchemaSOAP1_1::as_boolean;
...
sub as_undef {
    shift;
    my $value = shift;
        $value eq '1' || $value eq 'true'  ? 1
      : $value eq '0' || $value eq 'false' ? 0
